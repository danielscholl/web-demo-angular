...
This seed repo serves as an Angular 2 for use with the generator-dfwtalent-angular. Using [Webpack](http://webpack.github.io/) for building our files and assisting with boilerplate. We're also using Protractor for our end-to-end story and Karma for our unit tests.
